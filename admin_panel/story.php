                            ...
                            echo "
                                  <tr>
                                    ...
                                    <div class='dropdown-menu dropright'>
                  									<a class='dropdown-item' href='update_story.php?update_story=$r[0]'>Edit</a>
                  									<a class='dropdown-item' href='delete.php?story=$r[0]'>Delete</a>
									                   </div>
                                    </td>
                                  </tr>
             					          ";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="" method="POST" action="insert.php" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="story" value="story">Submit</button>
        </form>
      </div>
    </div>
  </div>