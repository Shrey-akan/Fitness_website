                            ...
                            echo "
                                  <tr>
                                    ...
                                    <div class='dropdown-menu dropright'>
                  									<a class='dropdown-item' href='update_offer.php?update_offer=$r[0]'>Edit</a>
                  									<a class='dropdown-item' href='delete.php?offer=$r[0]'>Delete</a>
									                   </div>
                                    </td>
                                  </tr>
             					          ";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="" method="POST" action="insert.php" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="offer" value="offer">Submit</button>
        </form>
      </div>
    </div>
  </div>