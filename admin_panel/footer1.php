                            ...
                            echo "
                                  <tr>
                                    ...
                                    <div class='dropdown-menu dropright'>
                  									<a class='dropdown-item' href='update_footer1.php?update_footer1=$r[0]'>Edit</a>
                  									<a class='dropdown-item' href='delete.php?footer1=$r[0]'>Delete</a>
									                   </div>
                                    </td>
                                  </tr>
             					          ";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="" method="POST" action="insert.php" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="footer1" value="footer1">Submit</button>
        </form>
      </div>
    </div>
  </div>