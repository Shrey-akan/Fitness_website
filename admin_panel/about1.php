                        ...
                        while ($r = mysqli_fetch_array($res)) {
                            echo "
                                  <tr>
                                    ...
                                    <td>$r[1]</td>
                                    <td>$r[2]</td>
                                    <td><img src='uploads/about1/$r[3]' style='height:80px;'></td>
									...
									<a class='dropdown-item' href='update_about1.php?update_about1=$r[0]'>Edit</a>
									<a class='dropdown-item' href='delete.php?about1=$r[0]'>Delete</a>
									</div>
                                    </td>
                                  </tr>
             					";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="" method="POST" action="insert.php" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="about1" value="about1">LOGIN</button>
        </form>
      </div>
    </div>
  </div>