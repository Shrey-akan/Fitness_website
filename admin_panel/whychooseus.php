                            ...
                            echo "
                                  <tr>
                                    ...
                                    <div class='dropdown-menu dropright'>
                  									<a class='dropdown-item' href='update_whychooseus.php?update_whychooseus=$r[0]'>Edit</a>
                  									<a class='dropdown-item' href='delete.php?whychooseus=$r[0]'>Delete</a>
									                   </div>
                                    </td>
                                  </tr>
             					          ";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="" method="POST" action="insert.php" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="whychooseus" value="whychooseus">Submit</button>
        </form>
      </div>
    </div>
  </div>